...
let buttonNovoJogoDesaparecido = document.getElementById("btn-novo-jogo").style.display = "none"
...
var palavras = ['ALURA', 'FORCA', 'HTML', 'ORACLE', 'JAVASCRIPT', 'LOGICA', 'PROGRAMA', 'DESAFIO', 'EMPATIA', 'CULTURA', 'VIRTUDE', 'SUCESSO', 'ALEGIRA', 'ORGULHO', 'SENSATO', 'DEMANDA', 'ANSIOSO', 'INTUITO', 'CONDUTA', 'CORRETO', 'AVAREZA', 'TALENTO', 'SIMPLES'];
